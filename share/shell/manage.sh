...
*capsh+unshare/unshare will not keep the same container running in the same namspaces.
  ...
  echo -e "\nThe container absolute path is the directory used to store the container,for chroot,you can use /data/container-name,and for proot,you can use /home/container-name,but do not use directory in /sdcard,or you might run into problems !\n"
